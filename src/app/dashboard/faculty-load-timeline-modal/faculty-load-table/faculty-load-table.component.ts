...
@Component({
  selector: 'app-faculty-load-table',
  templateUrl: './faculty-load-table.component.html',
  styleUrls: ['./faculty-load-table.component.css'],
})
export class FacultyLoadTableComponent implements OnInit {
  @Input() facultyLoadTable: NewLoad;
  ...
  ngOnInit(): void {
    ...
    this.totalUnits = 0;
    this.fillDayArrays();
    this.currentFacultyLoad = this.facultyLoadTable.loadItem;
    this.getDays( this.facultyLoadTable.loadItem);
